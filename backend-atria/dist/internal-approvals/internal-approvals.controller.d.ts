...
export declare class InternalApprovalsController {
    private readonly internalApprovalsService;
    constructor(internalApprovalsService: InternalApprovalsService);
    ...
    approve(id: string, user: AuthenticatedUser, dto?: ApproveInternalApprovalDto): Promise<{
        id: string;
        title: string;
        copy: string | null;
        approval: {
    ...
    submitDelivery(id: string, user: AuthenticatedUser, file: Express.Multer.File, caption?: string): Promise<{
        id: string;
        fileName: string;
        fileUrl: string;
        fileType: string;

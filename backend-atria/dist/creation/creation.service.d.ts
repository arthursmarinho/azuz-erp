...
import { CreateDeliverableDto, CreationDeliverableStatus } from './dto/deliverable.dto';
import { InternalReviewDto } from '../kanban/dto/internal-review.dto';
export declare class CreationService {
    private readonly prisma;
    private readonly ai;
    private readonly content;
    private readonly kanban;
    private readonly calendar;
    constructor(prisma: PrismaService, ai: AiService, content: ContentService, kanban: KanbanService, calendar: CalendarService);
    ...
    createFromBriefPlan(userId: string, dto: CreateBriefPlanDto): Promise<{
        created: {
            posts: number;
            tasks: number;
        };
    ...
    private resolveTodoColumnId;
    getClientPipeline(clientId: string, from?: string, to?: string): Promise<{
        client: {
            id: string;
            companyName: string;
            avatarUrl: string | null;
    ...
    updateItemStatus(source: 'post' | 'event', id: string, status: CreationDeliverableStatus): Promise<{
        item: {
            id: string;
            source: "post";
            postId: string;
    ...
    createDeliverable(userId: string, dto: CreateDeliverableDto): Promise<{
        source: "post";
        item: {
            id: string;
            source: "post";
    ...
    updatePipelineInternalReview(userId: string, role: string, source: 'post' | 'event', id: string, dto: InternalReviewDto): Promise<{
        item: {
            id: string;
            source: "post";
            postId: string;
    ...
    private isPostDeliverableType;
    private mapDeliverableStatusToPostStatus;
    private mapPostStatusToPipeline;
    private mapPostStatusLabel;
    private mapPostTypeLabel;

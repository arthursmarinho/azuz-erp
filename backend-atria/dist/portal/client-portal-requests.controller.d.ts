...
import { ConvertClientRequestToTaskDto, RejectClientRequestDto } from '../client-requests/dto/client-request.dto';
export declare class ClientPortalRequestsController {

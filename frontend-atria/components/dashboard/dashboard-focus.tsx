        ...
        {tasks.length === 0 ? (
          ...
          <ul className="flex flex-col gap-2">
            {tasks.map((task) => (
              <li
                key={task.id}
                className="flex items-center justify-between gap-3 rounded-xl border border-[var(--atria-primary)]/6 px-3 py-2.5"
              >
                ...
                <span
                  className={cn(
                    ...
                    task.priority === "HIGH" || task.priority === "CRITICAL"
                      ...
                      : task.priority === "LOW"
                        ? "bg-[var(--atria-primary)]/8 text-[var(--atria-primary)]/60"
